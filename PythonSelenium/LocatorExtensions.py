...
driver.find_element_by_css_selector("#username").send_keys("Anna")      # The '#' is use only for css. CSS fastest locators in selenium
driver.find_element_by_css_selector(".password").send_keys("Green")     # The "." is only use in css for classname attribute
